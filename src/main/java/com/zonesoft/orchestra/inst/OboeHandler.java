...
public class OboeHandler extends InstrumentHandler {
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.oboe.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 68, 0);
	}
