...
public class BaritoneSaxphoneHandler extends InstrumentHandler {
	private int basePitch = -1, dynamic = 3;

	public BaritoneSaxphoneHandler() {
		super(new int[] { GLFW.GLFW_KEY_4, GLFW.GLFW_KEY_R, GLFW.GLFW_KEY_T, GLFW.GLFW_KEY_6, GLFW.GLFW_KEY_Y,
				GLFW.GLFW_KEY_7, GLFW.GLFW_KEY_U, GLFW.GLFW_KEY_8, GLFW.GLFW_KEY_I, GLFW.GLFW_KEY_O, GLFW.GLFW_KEY_0,
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.baritone_saxphone.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 67, 0);
	}
