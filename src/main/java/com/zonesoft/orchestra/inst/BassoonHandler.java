...
public class BassoonHandler extends InstrumentHandler {
	private int basePitch = -1, dynamic = 3;

	public BassoonHandler() {
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.bassoon.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 70, 0);
	}
