...
public class AltoSaxphoneHandler extends InstrumentHandler {
	private int basePitch = -1, dynamic = 3;

	public AltoSaxphoneHandler() {
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.alto_saxphone.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 65, 0);
	}
