...
public class PiccoloHandler extends InstrumentHandler {
	private int basePitch = -1, dynamic = 3;

	public PiccoloHandler() {
		super(new int[] { GLFW.GLFW_KEY_R, GLFW.GLFW_KEY_5, GLFW.GLFW_KEY_T, GLFW.GLFW_KEY_6, GLFW.GLFW_KEY_Y,
				GLFW.GLFW_KEY_U, GLFW.GLFW_KEY_8, GLFW.GLFW_KEY_I, GLFW.GLFW_KEY_9, GLFW.GLFW_KEY_O, GLFW.GLFW_KEY_0,
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.piccolo.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 72, 0);
	}
