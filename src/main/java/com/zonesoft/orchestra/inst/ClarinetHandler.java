...
public class ClarinetHandler extends InstrumentHandler {
	private int basePitch = -1, dynamic = 3;

	public ClarinetHandler() {
		super(new int[] { GLFW.GLFW_KEY_R, GLFW.GLFW_KEY_5, GLFW.GLFW_KEY_T, GLFW.GLFW_KEY_Y, GLFW.GLFW_KEY_7,
				GLFW.GLFW_KEY_U, GLFW.GLFW_KEY_8, GLFW.GLFW_KEY_I, GLFW.GLFW_KEY_9, GLFW.GLFW_KEY_O, GLFW.GLFW_KEY_P,
				GLFW.GLFW_KEY_MINUS, GLFW.GLFW_KEY_LEFT_BRACKET, GLFW.GLFW_KEY_EQUAL, GLFW.GLFW_KEY_RIGHT_BRACKET,
	...
	public boolean isReady(PlayerEntity player) {
		boolean flag = player.getHeldItemMainhand().getItem() == ItemLoader.clarinet.get()
	...
	protected void onStart() {
		sendMessage(ShortMessage.PROGRAM_CHANGE, 0, 71, 0);
	}
